                      ...
                      <Col sm={9}>
                        <Tab.Content>
                          ...
                          <Tab.Pane eventKey="second">
                            ...
                            <p className={ styles.date }>Febuary 2022 - Present</p>
                            <ul>
                              <li>Work closely with application engineers, project managers, and key stakeholders within the DOM to understand the needs of our users and ship a product that serves those requirements.</li>
                              <li>Design and build front-end applications and components for the DOM’s Business Operations site via HTML, CSS, JavaScript, PHP, SQL, and related technologies/tools. </li>
                              <li>Convert reports to KoolReports for faster and easier report delivery as well as apply custom CSS to improve the styling.</li>
                              <li>Participate in code reviews and receive technical guidance from experienced senior application engineers.</li>
                            </ul>
                          </Tab.Pane>
